...
"""Test the signature generated by 'walletprocesspsbt' RPC call.
"""
...
class PSBTSignatureTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #create multisig redeem script from node 2 (legacy p2sh) - with the given pubkeys
        ...
        #get the p2sh output
        vout = funding_raw["vout"][p2sh_out_index]
        ...
        #value of the output
        value = funding_raw["vout"][p2sh_out_index]["value"]
        assert value == p2sh_value

        #this will be used when we sign the inputs spending the p2sh output
        prev_txs = [{"txid": txid, "vout": p2sh_out_index, "scriptPubKey": scriptPubKey, "redeemScript": p2sh["redeemScript"], "amount": value}]

        node0.generate(1)
        self.sync_all()
                
        #create a transaction that spends the p2sh output - sends the fund to hardcoded 2Mx1vp4fnSeHEbWopkGvgjpDittT3Vt4uvQ
        raw_tx = node1.createrawtransaction([{"txid": txid, "vout": p2sh_out_index}], [{"2Mx1vp4fnSeHEbWopkGvgjpDittT3Vt4uvQ": value}])
        # print("\nRAW_TX:"+str(raw_tx)) #0200000001754c96b3b8f4087642b6f0a11d7734a08bd7938cbd3dbeea6daebf29c8b7fd440000000000ffffffff0100ca9a3b0000000017a9143454e2293ed9790e578ae1353ffe1ef1d4a6b34a8700000000
